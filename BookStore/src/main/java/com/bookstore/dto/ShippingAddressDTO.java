...
public class ShippingAddressDTO {
	...
	public ShippingAddressDTO(Long id, String shippingAddressName, String shippingAddressStreet1,
			String shippingAddressStreet2, String shippingAddressCity, String shippingAddressState,
			String shippingAddressCountry, String shippingAddressZipcode, OrderDTO order) {
		super();
		this.id = id;
	...
	public String toString() {
		return "ShippingAddressDTO [id=" + id + ", shippingAddressName=" + shippingAddressName
